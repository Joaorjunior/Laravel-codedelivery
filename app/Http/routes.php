...
//Erro Target [CodeDelivery\Repositories\ClientRepository] is not instantiable.
App :: bind ( 'CodeDelivery\Repositories\ProductRepository' ,   'CodeDelivery\Repositories\ProductRepositoryEloquent' );
App :: bind ( 'CodeDelivery\Repositories\ClientRepository' ,   'CodeDelivery\Repositories\ClientRepositoryEloquent' );

//Route :: resource ( 'posts' ,  'PostsController' );

//Adicionar (Na versão Laravel 5.2 não vem)
// Autenticação routes...
